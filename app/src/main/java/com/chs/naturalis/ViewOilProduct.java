...
import static com.chs.naturalis.OilProducts.getOilProductName;
...
public class ViewOilProduct extends AppCompatActivity {
    ...
    private static final Logger LOGGER = getLogger(ViewOilProduct.class.getName());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_oil_product);
    ...
    /**
     * View all the details about the oil product selected by the user.
     */
    private void viewProduct() {
        //Take the product name when the client clicked on in it within the ViewOilProducts class
        String productName = getOilProductName();
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                makeText(ViewOilProduct.this, "Error on retrieving data from database.", LENGTH_LONG).show();
            }
        });
    }
    ...
    private void transitionToHomePageClientActivity() {
        new Handler().post(() -> {
            Intent intent = new Intent(ViewOilProduct.this, HomePageClient.class);
    ...
    /**
     * Sliding left opens the {@link OilProducts} activity.
     */
    public boolean onTouchEvent(MotionEvent touch) {
        switch (touch.getAction()) {
            ...
            case ACTION_UP:
                ...
                if (x1 < x2) {
                    Intent intent = new Intent(ViewOilProduct.this, OilProducts.class);
                    startActivity(intent);
                }
                break;
        }
    ...
    private void showAlertBoxForAddingAProductToCart() {
        AlertDialog.Builder builder = new AlertDialog.Builder(ViewOilProduct.this);
